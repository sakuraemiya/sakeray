...
import com.lesein.common.base.util.IdGeneratorUtil;
...
public class ${serviceClass} extends ${superServiceClass}<${daoClass}, ${entityClass}> {
	 ...
	 * @param request
	 */
	public PageUtil<${dtoClass}> selectPage(${requestSearchClass} request) {
		...
		return new PageUtil<>(resultList, count, request);
	}
