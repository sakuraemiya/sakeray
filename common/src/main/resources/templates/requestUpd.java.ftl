 ...
 * @since ${date}
 */
public class ${requestUpdateClass} extends ${superRequestClass} implements Serializable {
    ...
    public ${requestUpdateClass} set${pro.propertyName?cap_first}(${pro.propertyType} ${pro.propertyName}) {
        <#if pro.propertyType == 'String'>
