 ...
 * @since ${date}
 */
public class ${requestAddClass} extends ${superRequestClass} implements Serializable {
	...
	public ${requestAddClass} set${pro.propertyName?cap_first}(${pro.propertyType} ${pro.propertyName}) {
		<#if pro.propertyType == 'String'>
