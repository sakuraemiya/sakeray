package com.lesein.common.base.generator.builder;
...
import com.lesein.common.base.generator.constant.ConstValue;
import com.lesein.common.base.generator.constant.NamingStrategyHelper;
...
public class ConfigBuilder {
        ...
        try {
            ...
            while (results.next()) {
                ...
                if (StringUtils.isNotEmpty(tableName)) {
                    ...
                    tableInfo.setComment(StringUtils.defaultString(tableComment));
    ...
    private TableInfo convertTableFields(TableInfo tableInfo) {
        ...
        try {
            ...
            while (results.next()) {
                ...
                field.setFieldName(dataSourceConfig.getTypeConvert().customerName(fieldName));
                ...
                field.setComment(StringUtils.defaultString(results.getString(dbQuery.fieldComment())));
                ...
                field.setTypeHandler(isTypeHandler);
                if(isTypeHandler){
    ...
    public ConfigBuilder setClazzList(List<String> clazzList) {
